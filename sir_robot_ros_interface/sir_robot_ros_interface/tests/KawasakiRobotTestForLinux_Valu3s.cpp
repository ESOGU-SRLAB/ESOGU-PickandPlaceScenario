...
#include <sir_robot_ros_interface/srv/manipulator_pose.hpp>
#include <iostream>
#include <vector>
...
void add(const std::shared_ptr<sir_robot_ros_interface::srv::ManipulatorPose::Request> req,
         std::shared_ptr<sir_robot_ros_interface::srv::ManipulatorPose::Response> res)
{
...
int main(int argc, char **argv) {
  ...
  auto service = node->create_service<sir_robot_ros_interface::srv::ManipulatorPose>(
