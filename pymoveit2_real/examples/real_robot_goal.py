...
class RealCollisionAwareRobotController(Node):
    def __init__(self):
        ...
        self.moveit2.planner_id = "TRRTkConfigDefault"  # Daha güvenilir planlayıcı
...
def main():
    ...
    robot_controller = RealCollisionAwareRobotController()
