...
class CollisionAwareRobotController(Node):
    def __init__(self):
        ...
        self.moveit2.max_velocity = 0.045
        self.moveit2.max_acceleration = 0.045
...
def main():
    ...
    pose2_joints = [1.7, math.radians(26.14), math.radians(-77.11), math.radians(19.38), math.radians(-81.36), math.radians(0.0), math.radians(0)]
    pose3_joints = [1.0, math.radians(0), math.radians(-90), math.radians(0), math.radians(-90), math.radians(0.0), math.radians(0)]
    pose4_joints = [0.3, math.radians(-19.86), math.radians(-68.66), math.radians(32.65), math.radians(-93.61), math.radians(0.0), math.radians(0)]
