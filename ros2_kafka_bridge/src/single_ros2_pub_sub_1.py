...
class single_ros2_pub_sub_1():
    ...
    def __init__(self, args=None):
        ...
        self.pub = self.node.create_publisher(String, 'ros2_to_bridge_topic_1',qos)
        self.sub = self.node.create_subscription(String, '/bridge_to_ros2_topic_1', self.bridge_callback,qos)
    ...
    def bridge_callback(self, topic_1_data):
        self.node.get_logger().info('I heard: [%s]' , topic_1_data)
