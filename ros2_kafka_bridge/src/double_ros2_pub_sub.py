...
class double_ros2_pub_sub():
    ...
    def __init__(self, args=None):
        ...
        self.pub1 = self.node.create_publisher(String, 'ros2_to_bridge_topic_1',qos)
        self.pub2 = self.node.create_publisher(String, 'ros2_to_bridge_topic_2',qos)
        self.sub1 = self.node.create_subscription(String, '/bridge_to_ros2_topic_1', self.bridge_callback_1,qos)
        self.sub2 = self.node.create_subscription(String, '/bridge_to_ros2_topic_2', self.bridge_callback_2,qos)
